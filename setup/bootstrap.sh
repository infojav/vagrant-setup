...
echo "@infojav: -----> Changing to dummy password"
...
echo "@infojav: -----> Patching pg_hba to change -> socket access"
...
echo "@infojav: -----> Altered login to use md5 not peer:"
...
echo "@infojav: -----> Patching complete, restarting"
